...
Vixy YouTube Embed (formally Artiss YouTube Embed) is an incredibly simple, yet powerful, method of embedding YouTube videos into your WordPress site. Options include:
...
**You can even make money from this plugin too - see the appropriate section in "Other Notes" for further details.**
...
The above should get you started - for more information and advanced options please read the "Other Notes" tab. This also includes details on how to migrate from another embedding plugin to Vixy YouTube Embed.

Although this document contains a lot of information more is available from a series of linked pages, plus as much information as possible is provided on the various administration pages. Whilst on the administration pages, click on the "Help" button in the top right for some useful tips and links. If anything isn't covered and you're unsure of what it does please ask [on the forum](http://wordpress.org/support/plugin/youtube-embed "WordPress.org Forum").
...
**For help with this plugin, or simply to comment or get in touch, please read the appropriate section in "Other Notes" for details.**
